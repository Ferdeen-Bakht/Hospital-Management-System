    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="a_add_doctor.php">Add Doctors</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
  <h1 class="mt-5">Add doctor</h1>
  <button id="add_btn" class="mt-3 btn btn-primary">Add doctor</button>

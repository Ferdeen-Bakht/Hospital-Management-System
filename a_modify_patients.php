    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="a_modify_patients.php">Modify Patient Details</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
  <h1 class="mt-5">Modify Patient</h1>
  <button id="add_btn" class="mt-3 btn btn-primary">Modify patient</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Modify patients</h4>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="add-patient-attr-btn">Add Doctor</button>
  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.status == 'success') {
        ...
        cardBody.innerHTML = '<h5 class="card-title">' + response.name + '</h5><p class="card-text">' + response.email + '</p>';

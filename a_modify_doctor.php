    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="a_modify_doctor.php">Modify Doctor Details</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
  <h1 class="mt-5">Modify doctor</h1>
  <button id="add_btn" class="mt-3 btn btn-primary">Modify doctor</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="add-patient-attr-btn">Modify Doctor</button>
